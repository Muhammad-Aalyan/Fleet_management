    ...
    <div className="rd-login-page">
      ...
      <div className="rd-login-card">
        ...
        {step === 'credentials' ? (
          <>
            <h1>Welcome Back</h1>
            <p className="sub">Sign in to book your ride</p>
            ...
            <div className="rd-login-divider"><span>Don't have an account?</span></div>
            <Link to="/register">
              <button type="button" className="rd-btn-secondary">Create Account</button>
            </Link>
          </>
        ) : (
          <>
